...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  ">English</a>
      ...
      <a href="{{ url('lang/ne') }}" class="text-base @if(app()->getLocale() == 'ne') border border-slate-800 bg-slate-800 px-4 rounded-md  @else hover:text-black hover:scale-110 transition-transform @endif
  ">Nepali</a>
    </div>
  </div>
