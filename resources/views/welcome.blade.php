...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <header>
    <div class="top-nav-wrapper">
      <div class="top-nav flex justify-end bg-blue-500">
        <ul class="flex gap-4 flex-wrap bg-gradient-to-tr from-blue-500 to-green-500 p-2">
...
{{--  --}}
        <div class="footer-list-container">
          ...
          <ul class="footer-list flex flex-col gap-1">
            ...
            {{-- social links --}}
            <ul class="flex ">
              <li><a href="/" ><i class="fa-brands fa-square-facebook text-2xl hover:text-blue-400 transition-colors " ></i></a></li>
              <li><a href="/"><i class="fa-brands fa-square-instagram text-2xl hover:text-blue-400 transition-colors "></i></a></li>
              <li><a href="/" ><i class="fa-brands fa-square-youtube text-2xl  hover:text-blue-400 transition-colors "></i></a></li>
            </ul>
          </ul>
        </div> 
{{--  --}}
...
{{--  --}}
      ...
      <div class="text-center footer-lower bg-green-800 p-4">
