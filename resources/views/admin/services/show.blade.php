...
<div class="p-6">
  ...
  <div class="flex justify-between items-center my-4">
    ...
    <a href="{{route('admin.services.get.create')}}" class="btn hover:bg-slate-800 hover:text-white">Add Service</a>
  </div>
                    ...
                    <tr class="text-gray-700">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          ...
                          <form action="{{route('services.delete')}}" method="POST" class="m-0">
                            @csrf
