...
<div class="p-6">
  ...
  <div class="flex justify-between items-center my-4">
    ...
    <a href="{{route('admin.gallery.create')}}" class="btn hover:bg-slate-800 hover:text-white">Add Album</a>
  </div>
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      <th class="px-4 py-3">Album Name</th>
                      <th class="px-4 py-3">Album Image</th>
                      <th class="px-4 py-3">Total Images</th>
                    ...
                    <tr class="text-gray-700">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          <a href="{{route('admin.gallery.get.edit',['id'=> $item['id']])}}">
                          <button
                  ...
                  @if (count($albums) == 0)
                      <div class="text-center">
                        <h1 class="my-20 font-semibold text-gray-600 text-base">No albums added</h1>
                        </div> 
                  @endif
              <div
