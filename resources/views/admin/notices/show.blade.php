...
<div class="p-6">
  ...
  <div class="flex justify-between items-center my-4">
    ...
    <a href="{{route('admin.notices.get.create')}}" class="btn hover:bg-slate-800 hover:text-white">Add Notices</a>
  </div>
                  ...
                  @foreach ($notices as $notice)
                    <tr class="text-gray-700">
                      ...
                      <td class="px-4 py-3 text-sm">
                        <img src="/images/notices/{{$notice->image}}"
                        class="max-w-[150px]"/>
                      </td>
                      <td class="px-4 py-3 text-xs ">
                        <p class="text-sm">
                        {{substr($notice->description,0,25).'...'}}
                        </p>
                      </td>
                      <td class="px-4 py-3 text-sm">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center space-x-4 text-sm">
                          <a href="{{route('admin.notices.get.edit',['id'=> $notice['id']])}}">
                          <button
                          ...
                          <form action="{{route('notices.delete')}}" method="POST">
                            @csrf
